...
export const metadata: Metadata = {
  title: "Webild - AI Chat for Websites",
  description: "Transform your website with AI-powered chat. Webild engages visitors 24/7 with intelligent conversations. Start free in 5 minutes.",
  keywords: "AI chatbot, website chat, conversational AI, customer engagement",
  openGraph: {
    title: "Webild - AI Chat for Websites",
    description: "AI-powered chat that transforms website engagement. Try free today.",
    siteName: "Webild"
  }
};
